...
(function() {
  ...
  hexEnv.mouseUp = function(e) {
    ...
    if (!(this.posEqual(this.from, to) ? (to.x + "_" + to.y) in this.arrows : void 0)) {
      return;
    }
    if ("temp" in this.arrows) {
      this.arrows["temp"].hide();
    }
    return this.moveFunc(this.from, to, this.board.attr("id"));
  };
  ...
  hexEnv.drawBoard = function(moves, board_data, board_users) {
    ...
    while (i < moves.length) {
      ...
      key = move[0] + "_" + move[1];
      if (tmparr.length ? tmparr.data("pos") === key : void 0) {
        tmparr.hide();
      }
  ...
  HexController = (function() {
    ...
    HexController.prototype.start = function() {
      ...
      hexEnv.ajax(this.url_board, 2000, {
        board_id: 'board1'
      }, this.init_board);
