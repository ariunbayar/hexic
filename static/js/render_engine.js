...
(function() {
  ...
  Engine = (function() {
    ...
    Engine.prototype.board = [];

    Engine.prototype.svg = null;

    function Engine(container_id, width, height) {
      this.svg = Graphics.createSVG(container_id, width, height);
    }

    Engine.prototype.updateBoard = function(board) {
    ...
    Engine.prototype._newCellAt = function(x, y) {
      return new Cell({
        el_svg: this.svg,
        position: {
          x: x,
    ...
    Engine.prototype._getColor = function(user_id) {
      var i, num_users;
